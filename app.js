const myMap = L.map('map').setView([20.5937, 78.9629], 5);
...
const tilesLayer = L.tileLayer(tileUrl, { attribution });
...
function flyToStore(store) {
    ...
    const lng = store.geometry.coordinates[0];
     myMap.flyTo([store.geometry.coordinates[1], store.geometry.coordinates[0]], 14, {
         duration: 3
     });
     setTimeout(() => {
